...
function NotifyUserForDownload() {

    var response = confirm('Images will start downloading. This process may take a few minutes. You will be redirected when download completes. OK to continue or Cancel.');
    ...
    if (response) {
        ...
        waitingDialog.show('Downloading rover image files ...');
        
        window.location.href = "/home/downloadfiles";        
    }
}
